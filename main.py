...
##################################################################################################
##################################################################################################
def pentration_through_pieces_checker_VERTICLE():
   global distance_start_finish_y ,direction, pentration
   direction = "neutral"
   pentration = False
...
#pawn normal move 
    ...
    #Checks if the moves goes through any pieces 
    if pentration == True:  # DO SOMETHING TO MAKE KNIGHT UNAFFECTED
        legal_move = True
